...
> Built a machine learning model to predict customer churn. Performed data preprocessing, feature engineering, and model evaluation. Improved customer retention insights using predictive analytics.

**Tech:** Python • TensorFlow • Pandas • Data Preprocessing • Feature Engineering

 🎵 **Music Mood Mapper (Django)**
> Developed a Django-based web application that maps user-selected music to moods. Integrated backend logic with a clean UI.

**Tech:** Django • Python • HTML • CSS • JavaScript • Backend Logic

 📁 **Certificate Manager Application**
> Designed an application to manage and organize certificates. Focused on usability, storage, and retrieval. Implemented efficient data handling.

**Tech:** Python • SQL • UI Design • Data Management • Efficiency Optimization
